...
wget https://personal.broadinstitute.org/konradk/loftee_data/GRCh38/human_ancestor.fa.gz -O $HA_FILE
wget https://personal.broadinstitute.org/konradk/loftee_data/GRCh38/human_ancestor.fa.gz.fai -O $HA_FILE_INDEX

# GERP bigwig - ~12GiB
GERP_FILE=$VEP_REF_DIR/gerp_conservation_scores.homo_sapiens.GRCh38.bw
wget https://personal.broadinstitute.org/konradk/loftee_data/GRCh38/gerp_conservation_scores.homo_sapiens.GRCh38.bw -O $GERP_FILE
